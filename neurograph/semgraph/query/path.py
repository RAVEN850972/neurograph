    ...
    def find_weighted_shortest_path(self, start: str, end: str,
        ...
        while nodes:
            ...
            for edge in self._get_outgoing_edges(current, edge_types):
                ...
                # Пропускаем соседей, которые уже обработаны
                if neighbor not in nodes:
                    continue
                    
                # Получаем вес ребра
                weight = self.graph.get_edge_weight(edge[0], edge[1], edge[2]) or 1.0
                ...
                if distance < distances[neighbor]:
                    ...
                    previous[neighbor] = (current, edge[2])  # Сохраняем узел и тип ребра
